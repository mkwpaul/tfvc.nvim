...
---@field pending_changes? table<pending_change>
...
---@field user_vars tfvc_user_vars proxy obj for user-options access, don't use this to set options
 local M = {}
...
function M.get_cached_file_version(versionspec, file)
